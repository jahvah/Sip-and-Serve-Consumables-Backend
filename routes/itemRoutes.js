...
========================= */
router.put("/update", auth, admin, controller.updateItem);
...
router.delete("/main-image/:item_id", auth, admin, controller.deleteMainImage);
...
router.delete("/image/:id", auth, admin, controller.deleteImage);

/* =========================
   ADMIN ONLY - DELETE ITEM
========================= */
router.delete("/delete/:id", auth, admin, controller.deleteItem);
